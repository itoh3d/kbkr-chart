...
var kabu_datasets = [
    ...
    { label : 'goron__chan' , data : [{ x : 31.3, y: 628, r: 14.5 }]},
    { label : 'pyamarz' , data : [{ x : 23, y: 19, r: 2.8 }]},
    { label : 'HappyHikingDay' , data : [{ x : 21, y: 43, r: 4.5 }]},
    { label : 'btlr6P1YjrlTMjX' , data : [{ x : 14.7, y: 177, r: 10.5 }]},
    ...
    { label : 'kabu1000' , data : [{ x : -3.8, y: 984, r: 44.5 }]},
    { label : 'MrM1101' , data : [{ x : -4, y: 4, r: 2.8 }]},
    { label : 'ACdc97757716' , data : [{ x : -4.2, y: 4, r: 2.8 }]},
    { label : 'bellppy_25' , data : [{ x : -8.1, y: 851, r: 27.7 }]},
