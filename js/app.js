...
var kabu_datasets = [
    ...
    { label : '2525mementomori' , data : [{ x : 225.1, y: 69, r: 2.8 }]},
    { label : 'fugo_hahahablog' , data : [{ x : 107.1, y: 52, r: 2.8 }]},
    { label : 'MrRabbit9119' , data : [{ x : 103.4, y: 51, r: 2.8 }]},
    { label : 'duck_stock' , data : [{ x : 88, y: 47, r: 2.8 }]},
    { label : 'sistinavc' , data : [{ x : 78, y: 2841, r: 22.7 }]},
    { label : 'futsuubito' , data : [{ x : 76.9, y: 1057, r: 13.9 }]},
    { label : 'reuse_theta' , data : [{ x : 55.9, y: 36, r: 2.8 }]},
    { label : 'FAA_X64' , data : [{ x : 41, y: 29, r: 2.8 }]},
    { label : 'so19715552' , data : [{ x : 40, y: 29, r: 2.8 }]},
    { label : 'mogmoggaboo' , data : [{ x : 32.3, y: 81, r: 5.1 }]},
    { label : 'RokuSQ_All' , data : [{ x : 31, y: 24, r: 2.8 }]},
    { label : 'fujitaxian' , data : [{ x : 30, y: 23, r: 2.8 }]},
    { label : 's13776387' , data : [{ x : 28, y: 22, r: 2.8 }]},
    { label : '_sakai_029' , data : [{ x : 27.3, y: 634, r: 15.3 }]},
    { label : 'buraihhh' , data : [{ x : 25.6, y: 131, r: 7.1 }]},
    { label : 'pav_kabu' , data : [{ x : 25.1, y: 20, r: 2.8 }]},
    { label : 'MUCHO84928709' , data : [{ x : 25, y: 120, r: 6.9 }]},
    { label : 'investsprinter' , data : [{ x : 24.7, y: 20, r: 2.8 }]},
    { label : 'akinorimuraoka' , data : [{ x : 21.5, y: 18, r: 2.8 }]},
    { label : 'takede3' , data : [{ x : 19.7, y: 16, r: 2.8 }]},
    { label : '000kani000' , data : [{ x : 19.5, y: 16, r: 2.8 }]},
    { label : 'hajimeteosun' , data : [{ x : 19.3, y: 16, r: 2.8 }]},
    { label : 'lmhouqi20W4W82N' , data : [{ x : 18.7, y: 16, r: 2.8 }]},
    { label : 'toushikarasu' , data : [{ x : 18, y: 102, r: 7.3 }]},
    { label : 'ns4Z88PtaQnJRjS' , data : [{ x : 16.9, y: 1117, r: 24.8 }]},
    { label : 'Quanta1918' , data : [{ x : 16.3, y: 14, r: 2.8 }]},
    { label : 'Mashiyama' , data : [{ x : 16.2, y: 14, r: 2.8 }]},
    { label : 'Ozii0' , data : [{ x : 16.1, y: 14, r: 2.8 }]},
    { label : 'itoh3d' , data : [{ x : 15.7, y: 398, r: 15.3 }]},
    { label : 'maboooxxx' , data : [{ x : 15.5, y: 13, r: 2.7 }]},
    { label : 'posicx' , data : [{ x : 15.1, y: 236, r: 12 }]},
    { label : 'Sasukenokabu' , data : [{ x : 15, y: 178, r: 10.4 }]},
    { label : 'rabbit_invest' , data : [{ x : 14.8, y: 13, r: 2.8 }]},
    { label : 'A77777K' , data : [{ x : 13.2, y: 12, r: 2.8 }]},
    { label : 'masakabu1213' , data : [{ x : 12.7, y: 71, r: 7.1 }]},
    { label : 'highmix' , data : [{ x : 12.2, y: 11, r: 2.8 }]},
    { label : 'strade18644883' , data : [{ x : 12, y: 35, r: 5.1 }]},
    { label : 'kedamafire' , data : [{ x : 10.1, y: 9, r: 2.8 }]},
    { label : 'shibainucyan' , data : [{ x : 10, y: 9, r: 2.8 }]},
    { label : 'Crescent5225675' , data : [{ x : 9.2, y: 91, r: 9.3 }]},
    { label : 'musou1231' , data : [{ x : 8.8, y: 539, r: 23 }]},
    { label : '100_million_yen' , data : [{ x : 8.7, y: 8, r: 2.8 }]},
    { label : 'Mr68818662' , data : [{ x : 7.8, y: 31, r: 5.9 }]},
    { label : 'yshida02161' , data : [{ x : 7.4, y: 67, r: 8.8 }]},
    { label : 'syusendokoala' , data : [{ x : 6.1, y: 6, r: 2.8 }]},
    { label : 'TkxQMsTYUZQlFlN' , data : [{ x : 5.8, y: 5, r: 2.8 }]},
    { label : 'keeping_safety' , data : [{ x : 5.7, y: 5, r: 2.8 }]},
    { label : 'k_investment7' , data : [{ x : 5.2, y: 67, r: 10.4 }]},
    { label : 'Zuca69507725' , data : [{ x : 5, y: 5, r: 2.8 }]},
    { label : 'saki_in' , data : [{ x : 4.9, y: 545, r: 30.4 }]},
    { label : 'ika_toushi' , data : [{ x : 4.8, y: 5, r: 2.8 }]},
    { label : 'micchimicchi14' , data : [{ x : 4.6, y: 4, r: 2.8 }]},
    { label : 'welovesfruits' , data : [{ x : 4.6, y: 4, r: 2.8 }]},
    { label : 'ABE_Sato' , data : [{ x : 4.6, y: 4, r: 2.8 }]},
    { label : 'AyMkabu' , data : [{ x : 4.3, y: 21, r: 6.4 }]},
    { label : 'OhtaResearch' , data : [{ x : 4.1, y: 4, r: 2.8 }]},
    { label : 'kabukabubanana' , data : [{ x : 4, y: 4, r: 2.8 }]},
    { label : 'tarosan_0121' , data : [{ x : 4, y: 4, r: 2.8 }]},
    { label : 'free_worker_jp' , data : [{ x : 3.9, y: 54, r: 10.6 }]},
    { label : 'EijiroTanaka' , data : [{ x : 3.8, y: 4, r: 2.8 }]},
    { label : 'akitatomohiro' , data : [{ x : 3.8, y: 46, r: 10.1 }]},
    { label : 'josefire8' , data : [{ x : 3.6, y: 3, r: 2.8 }]},
    { label : 'takefund' , data : [{ x : 3.6, y: 3, r: 2.8 }]},
    { label : 'KabuFactory' , data : [{ x : 3.5, y: 3, r: 2.8 }]},
    { label : 'pip99577080' , data : [{ x : 3.2, y: 3, r: 2.8 }]},
    { label : 'fujio0702' , data : [{ x : 3, y: 3, r: 2.8 }]},
    { label : 'YGkoPanda' , data : [{ x : 2.7, y: 3, r: 2.8 }]},
    { label : '2004Aki' , data : [{ x : 2.6, y: 3, r: 2.8 }]},
    { label : 'chun3' , data : [{ x : 2.6, y: 39, r: 11.1 }]},
    { label : 'kaburiber2' , data : [{ x : 2.5, y: 2, r: 2.8 }]},
    { label : 'piDPe9s73i6rnOc' , data : [{ x : 2.3, y: 2, r: 2.8 }]},
    { label : 'RedCarrot4' , data : [{ x : 2.3, y: 2, r: 2.8 }]},
    { label : 'yasakabu' , data : [{ x : 2.2, y: 2, r: 2.8 }]},
    { label : 'sekiro04130808' , data : [{ x : 2, y: 2, r: 2.8 }]},
    { label : '0124abc123' , data : [{ x : 2, y: 2, r: 2.8 }]},
    { label : 'castle_pointer' , data : [{ x : 1.5, y: 1, r: 2.8 }]},
    { label : 'MrM1101' , data : [{ x : 1.4, y: 1, r: 2.8 }]},
    { label : 'takakatsutoshi3' , data : [{ x : 1.4, y: 1, r: 2.8 }]},
    { label : 'kr_kabu' , data : [{ x : 1.3, y: 1, r: 2.8 }]},
    { label : 'syou36_investor' , data : [{ x : 1, y: 1, r: 2.8 }]},
    { label : 'momokurin' , data : [{ x : 1, y: 1, r: 2.8 }]},
    { label : 'MrKabumania' , data : [{ x : 1, y: 1, r: 2.8 }]},
    { label : 'ok94098' , data : [{ x : 0.8, y: 1, r: 2.8 }]},
    { label : 'ACdc97757716' , data : [{ x : 0.7, y: 1, r: 2.8 }]},
    { label : 'kai83660' , data : [{ x : 0.7, y: 1, r: 2.8 }]},
    { label : 'trader_hashang' , data : [{ x : 0.6, y: 212, r: 53.2 }]},
    { label : 'castlefrom0' , data : [{ x : 0.2, y: 0, r: 2.8 }]},
    ...
    { label : 'kabusaga' , data : [{ x : -0.9, y: 1, r: 2.8 }]},
    { label : 'yuukabukabu' , data : [{ x : -1, y: 22, r: 13.2 }]},
    ...
    { label : 'okuzawayukichi' , data : [{ x : -6.9, y: 18, r: 4.4 }]},
    { label : 'sato198358' , data : [{ x : -10.2, y: 11, r: 2.8 }]},
